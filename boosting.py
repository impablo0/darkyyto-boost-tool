...
os.system(f"title boost tool by discord.gg/999shops By Boka#0884/! dxnii#6826")    
...
''')
print(Fore.YELLOW + "\n Welcome 999"+ Fore.RED + "\n Enter in discord.gg/999shops\n\n\n" + Fore.RESET)
print(f'''{Style.BRIGHT}{Fore.BLUE}                            ╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾''' + Fore.RESET)
print(f'''{Style.BRIGHT}{Fore.WHITE}                            Token Stock 1 Mese: {len(open('input/1m_tokens.txt', 'r').read().splitlines())} Boost Stock 1 Mese: {len(open('input/1m_tokens.txt', 'r').read().splitlines()) * 2}''' + Fore.RESET)	
print(f'''{Style.BRIGHT}{Fore.WHITE}                            Token Stock 3 Mesi: {len(open('input/3m_tokens.txt', 'r').read().splitlines())} Boost Stock 3 Mesi: {len(open('input/3m_tokens.txt', 'r').read().splitlines()) * 2}''' + Fore.RESET)	
print(f'''{Style.BRIGHT}{Fore.BLUE}                            ╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾''' + Fore.RESET)
